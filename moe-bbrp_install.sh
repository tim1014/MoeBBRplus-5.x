...
# Donwload
headurl=https://github.com/tim1014/MoeBBRplus-5.x/releases/download/5.10.29-bbrplus/linux-headers-5.10.29-bbrplus_5.10.29-bbrplus-1_amd64.deb
imgurl=https://github.com/tim1014/MoeBBRplus-5.x/releases/download/5.10.29-bbrplus/linux-image-5.10.29-bbrplus_5.10.29-bbrplus-1_amd64.deb
echo -e "\n\nDownload Header\n\n"
