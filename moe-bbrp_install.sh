...
# Donwload
headurl=https://github.com/tim1014/moe_bbrplus-5.10/releases/download/5.10.29-bbrplus/linux-headers-5.10.29-bbrplus_5.10.29-bbrplus-1_amd64.deb
imgurl=https://github.com/tim1014/moe_bbrplus-5.10/releases/download/5.10.29-bbrplus/linux-image-5.10.29-bbrplus_5.10.29-bbrplus-1_amd64.deb
echo "\n\nDownload Header\n\n"
...
# Install Kernel
dpkg -i '/tmp/linux-headers-5.10.29-bbrplus_5.10.29-bbrplus-1_amd64.deb'
dpkg -i '/tmp/linux-image-5.10.29-bbrplus_5.10.29-bbrplus-1_amd64.deb'
[ $? -eq 0 ] || exit 1 
